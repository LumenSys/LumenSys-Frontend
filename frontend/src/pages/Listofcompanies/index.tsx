// src/pages/Listofcompanies/index.tsx
import React, { useState } from "react";
import { useCompanies } from '../../context/CompanyContext';

const ListOfCompanies: React.FC = () => {
    const { companies } = useCompanies(); // Usar dados do contexto
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <p className="text-gray-600">
                        Gerencie todas as empresas cadastradas no sistema ({companies.length} empresa{companies.length !== 1 ? 's' : ''})
                    </p>
                </div>
